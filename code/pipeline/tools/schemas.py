"""Definições de tools (formato Anthropic tool-use) por papel de agente."""
...
WRITE_FILE = {
    ...
    "input_schema": {
        "type": "object",
        "properties": {
            "rel_path": {"type": "string", "description": "Caminho relativo, ex: backend/app/routers/nao_conformidade.py"},
...
RUN_BACKEND_TESTS = {
    ...
    "description": "Executa a suíte de testes (pytest) do backend em code/app/backend e retorna o resultado.",
    "input_schema": {
        "type": "object",
...
RUN_FRONTEND_TESTS = {
    ...
    "description": "Executa a suíte de testes do frontend em code/app/frontend e retorna o resultado.",
    "input_schema": {
        "type": "object",
