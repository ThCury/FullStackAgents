...
from fullstack_agents.domain.models import ProductBacklog, RunStatus, now_audit_time
...
class MongoRunRepository:
    ...
    def finish_call(self, run_id: str, call_id: str, fields: dict) -> None:
        updates = {f"audit.timeline.$[call].{key}": _to_mongo(value) for key, value in fields.items()}
