...
from fullstack_agents.domain.models import CostValue, RunTotals
...
class CostCalculator:
    ...
    def totals(self, input_tokens: int | None, output_tokens: int | None, cached_tokens: int | None, latency_ms: int) -> RunTotals:
